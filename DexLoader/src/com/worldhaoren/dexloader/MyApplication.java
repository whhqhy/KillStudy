...
public class MyApplication extends Application {
	...
	private void inject(String dexPath) {
		try {
			...
			Object baseElements = getField(pathList.getClass(), "dexElements",
					pathList);
			...
			DexClassLoader dexClassLoader = new DexClassLoader(dexPath, dexOpt,
					dexOpt, getClassLoader());
			Object dexPathList = getField(clz, "pathList", dexClassLoader);
			Object dexElements = getField(dexPathList.getClass(),
					"dexElements", dexPathList);

			// 合并2个Element
			Object combineElements = combineArray(dexElements, baseElements);

			// 将合并后的Element数组重新赋值给app的classLoader
			setField(pathList.getClass(), "dexElements", pathList,
					combineElements);
	...
	private Object getField(Class<?> cls, String fieldName, Object obj)
	 ...
	 * 通过反射设置对象的属性值
	 */
	private void setField(Class<?> cls, String fieldName, Object obj,
